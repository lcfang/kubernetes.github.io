...
See the guides in [Picking the Right Solution](/docs/setup/) for examples of how to plan, set up, and configure Kubernetes clusters. The solutions listed this article are called *distros*.
